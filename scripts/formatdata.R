...
st <- read.csv("data/InteractiveMap_wSameSexParents_State2015.csv",stringsAsFactors = F)
mt <- read.csv("data/InteractiveMap_wSameSexParents_Metro2015.csv",stringsAsFactors = F)
