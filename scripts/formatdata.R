...
st <- read.csv("data/InteractiveMap_wSameSexParents_State2017.csv",stringsAsFactors = F)
mt <- read.csv("data/InteractiveMap_wSameSexParents_Metro2017.csv",stringsAsFactors = F)
