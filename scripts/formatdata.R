...
st <- read.csv("data/InteractiveMap_wSameSexParents_State2021.csv",stringsAsFactors = F)
mt <- read.csv("data/InteractiveMap_wSameSexParents_Metro2021.csv",stringsAsFactors = F)
